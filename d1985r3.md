...
using apply_unwrap = T<unwrap_integral_constant<Params>::result...>;
...
introducing new keywords always comes with risks of breaking previously working
...
| :------------------: | :--------------: |
|    `template auto`   | `any name`       |
|    `auto template`   | `any kind`       |
|    `auto typename`   | `auto kind`      |
|    `typename auto`   | `unknown kind`   |
|    `template?`       | `universal name` |
|                      | `universal kind` |
|                      | `univ name`      |
|                      | `univ kind`      |
|                      | `indeterminate`  |
